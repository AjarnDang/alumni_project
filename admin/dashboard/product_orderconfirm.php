...
<div class="container-fluid">
      ...
      <div class="col-md-12">
        ...
        <div class="table-responsive">
          <table class="table m-0 table-bordered-danger">
            ...
            <?php
				...
				$sql = "SELECT * from orders  WHERE staytus='ชำระเงินแล้ว';
                        ORDER BY created_at 
			...
			?>
                ...
                <tr>
                  ...
                  <td>
                     ...
                     <a href="product_formorder.php?resid=<?php echo htmlentities($row['order_id']); ?>"><svg width="15" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <nav>
            <ul class="pagination">
                <li>
                    <a href="product_orderconfirm.php?page=1" aria-label="Previous">
                    <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
				<?php for($i=1;$i<=$total_page;$i++){ ?>
				<li>
					<a href="product_orderconfirm.php?page=<?php echo $i; ?>">
						<?php echo $i; ?></a></li>
				<?php } ?>
				<li>
					<a href="product_orderconfirm.php?page=<?php echo $total_page;?>" aria-label="Next">

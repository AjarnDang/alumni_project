...
?>
<!-- Edit -->
    <div class="modal fade" id="receive<?php echo $row['Product_ID']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <center><h4 class="modal-title" id="myModalLabel">นำเข้า</h4></center>
				...
				<form method="POST" action="product_receive.php?Product_ID=<?php echo $row['Product_ID']; ?>" enctype="multipart/form-data">
				...
				<div class="row">
						...
						<div class="col-lg-10">
							<input type="text" class="form-control" name="productName" readonly  value="<?php echo $row['productName']; ?>">
						</div>
					</div>
					<div class="row">
						<div class="col-lg-2">
					...
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="text" class="form-control" name="Price" readonly  value="<?php echo $row['Price']; ?>">
						</div>
					</div>
					<div class="row">
						<div class="col-lg-2">

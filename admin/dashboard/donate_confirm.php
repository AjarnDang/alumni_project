 ...
 <link rel="stylesheet" href="../../assets/css/defaultDashboard.css">
    <body>
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    ...
                    <tr>
                        ...
                        <td style="width:20%;">
                            <input type="text" class="form-control" name="Datee" id="dateSearch1" placeholder="วัน/เดือน/ปี  " onKeyup="filterSearchDate6()">
                        </td>
                        <td style="width:20%;">
				...
				$sql = "SELECT * from donate_stuff  WHERE Is_Active=0
                        ORDER BY created_at 
        ...
        <nav>
            <ul class="pagination">
                <li>
                    <a href="donate_confirm.php?page=1" aria-label="Previous">
                    <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
				<?php for($i=1;$i<=$total_page;$i++){ ?>
				<li>
					<a href="donate_confirm.php?page=<?php echo $i; ?>">
						<?php echo $i; ?></a></li>
				<?php } ?>
				<li>
					<a href="donate_confirm.php?page=<?php echo $total_page;?>" aria-label="Next">
  ...
  <script>
  function filterSearchDate6() {
    var input, filter, table, tr, td, i;
    input = document.getElementById("dateSearch1");
    filter = input.value.toUpperCase();
    table = document.getElementById("data_table");
    tr = table.getElementsByTagName("tr");
    for (i = 0; i < tr.length; i++) {

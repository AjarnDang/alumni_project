...
<div class="container">
    <div class="row">
					...
					foreach ($_SESSION["cart_session"] as $cart_itm) {
						...
						$total = ($total + $subtotal); } ?>
							...
							<div class="icon-badge-group">
								<a class="social-md" href="login-system/login_form.php">
      ...
      <div class="col-lg-3 col-md-4 col-sm-5 col-xs-6 text-right">
        <ul class="list-group list-group-horizontal">
          <li class=""><a class="social-md" href="login-system/login_form.php">เข้าสู่ระบบ </a></li>&nbsp;|&nbsp; 
          <li class=""><a class="social-md" target="_blank" href="login-system/register.php"> สมัครสมาชิก</a></li>
		</ul>
      </div>
    </div>
  </div>
...
<div class="container">
	<a class="navbar-brand" href="index.php"><img src="assets/img/sci_logo.png" alt="sci-logo"></a>
		...
		<ul class="navbar-nav">
			...
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle
					...
					<?= ($activePage == 'donate_thing') ? 'active' : ''; ?>
				" href="donate.php" data-bs-toggle="dropdown">
				บริจาค
				</a>
			    <ul class="dropdown-menu dropdown-menu-end">
				  <li><a class="dropdown-item" href="donate_money.php">บริจาคเงิน</a></li>
				  <li><a class="dropdown-item" href="donate_thing.php">บริจาคสิ่งของ</a></li>
			    </ul>
			</li>
